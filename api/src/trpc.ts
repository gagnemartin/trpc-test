...
import { client, subscriber, publisher } from './database/redis'
...
export const createTRPCContext = ({ req, res }: CreateExpressContextOptions | CreateWSSContextFnOptions) => {
...
export const authedProcedure = t.procedure.use(async function isAuthed(opts) {
  ...
  const decodedToken = await verifyToken(ctx.headers.authorization.replace('Bearer ', ''))
